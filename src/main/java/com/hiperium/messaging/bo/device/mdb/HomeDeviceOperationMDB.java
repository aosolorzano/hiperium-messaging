 ...
 * 
 */
@MessageDriven(name = "HomeDeviceOperationMDB", activationConfig = {
		@ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
		@ActivationConfigProperty(propertyName = "destination",     propertyValue = ConfigurationBean.HOME_DEVICE_OPERATION_QUEUE),
		@ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge")})
public class HomeDeviceOperationMDB extends GenericBusinessObject implements MessageListener {

	/** The LOGGER property for logger messages. */
	private static final HiperiumLogger LOGGER = HiperiumLogger.getLogger(HomeDeviceOperationMDB.class);
	...
	public void onMessage(Message message) {
		...
		try {
			...
			if(deviceDTO != null && super.getSessionManagerBO().isHomeLoggedIn(deviceDTO.getTokenId())) {
